...
export default {
  watch: {
    curValue: function(newVal, oldVal) {
      ...
      bus.$emit('vue-formular.change::' + this.name, {name:this.name, value:newVal, oldValue:oldVal});
      bus.$emit('vue-formular.change', {name:this.name, value:newVal, oldValue:oldVal});
