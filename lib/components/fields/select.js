  ...
  return merge.recursive(Field(),{
    ...
    mounted: function() {
      ...
      if (this.select2 || this.ajaxUrl) {
        ...
        if (typeof $=='undefined') {
         console.error('vue-formular: missing global dependency: vf-select with select2 depends on JQuery');
         return;
       }

       if (typeof $(this.$el).select2=='undefined') {
         console.error('vue-formular: missing global dependency: vf-select with select2 depends on Select2');
         return;
       }
