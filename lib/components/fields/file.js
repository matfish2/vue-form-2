  ...
  return merge.recursive(Field(),{
    ...
    mounted: function() {
      ...
      if (!this.ajax) return;
        ...
        if (typeof $=='undefined') {
         console.error('vue-formular: missing global dependency: vf-file with ajax depends on JQuery');
         return;
       }

       if (typeof $(this.$el).fileupload=='undefined') {
         console.error('vue-formular: missing global dependency: vf-file with ajax depends on the jQuery-File-Upload plugin');
         return;
       }
