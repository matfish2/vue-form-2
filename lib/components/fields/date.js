...
module.exports = function() {
  return merge.recursive(Field(), {
    ...
    mounted: function() {
      ...
      if (typeof $=='undefined') {
       console.error('vue-formular: missing global dependency: vf-date depends on JQuery');
       return;
     }
     ...
     if (typeof this.datepicker.daterangepicker=='undefined') {
      console.error('vue-formular: missing global dependency: vf-date depends on daterangepicker');
      return;
    }
    ...
    momentizeValue: function(val) {
      ...
      setValue: function(val) {
        ...
        try {
          ...
          let error =  `vue-formular: invalid date passed to field "${this.name}".`;
          error+= this.range?
