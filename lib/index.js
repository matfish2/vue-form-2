...
exports.install = function(Vue, globalOptions = {}, customFields) {
  ...
  var vfForm = {
    ...
    methods: {
      ...
      pristine: function() {
        return this.vuex
          ? this.$store.state[this.name].count === 0
          : this.vffields.length === 0;
      }
    }
  };
  ...
  Vue.component(
    "vf-file",
    require("./components/fields/file")(globalOptions.fileOptions)
  );
  Vue.component("vf-textarea", require("./components/fields/textarea")());
  Vue.component("vf-select", require("./components/fields/select")());
  Vue.component(
    "vf-buttons-list",
    require("./components/fields/buttons-list")()
  );
  Vue.component(
    "vf-address-finder",
    require("./components/fields/address-finder")()
  );
  ...
  Vue.component("vf-monthyear", require("./components/fields/month-year")());
